...
public class Session extends DataMessage {
    ...
    public Integer getTotalTrainingEffect() {
        final Number value = getFieldToNumber(Fields.TOTAL_TRAINING_EFFECT);
    ...
    public void setTotalTrainingEffect(final Integer totalTrainingEffect) {
        final Field<?> f = getOrAddField(Fields.TOTAL_TRAINING_EFFECT);
        f.setValue(totalTrainingEffect);
    }
    ...
    public Integer getFirstLapIndex() {
        final Number value = getFieldToNumber(Fields.FIRST_LAP_INDEX);
    ...
    public void setFirstLapIndex(final Integer firstLapIndex) {
        final Field<?> f = getOrAddField(Fields.FIRST_LAP_INDEX);
        f.setValue(firstLapIndex);
    }
    ...
    public Integer getNumLaps() {
        final Number value = getFieldToNumber(Fields.NUM_LAPS);
    ...
    public void setNumLaps(final Integer numLaps) {
        final Field<?> f = getOrAddField(Fields.NUM_LAPS);
        f.setValue(numLaps);
    }
    ...
    public Integer getTrigger() {
        final Number value = getFieldToNumber(Fields.TRIGGER);
    ...
    public void setTrigger(final Integer trigger) {
        final Field<?> f = getOrAddField(Fields.TRIGGER);
        f.setValue(trigger);
    }
    ...
    public Integer getNecLat() {
        final Number value = getFieldToNumber(Fields.NEC_LAT);
    ...
    public void setNecLat(final Integer necLat) {
        final Field<?> f = getOrAddField(Fields.NEC_LAT);
        f.setValue(necLat);
    }
    ...
    public Integer getNecLong() {
        final Number value = getFieldToNumber(Fields.NEC_LONG);
    ...
    public void setNecLong(final Integer necLong) {
        final Field<?> f = getOrAddField(Fields.NEC_LONG);
        f.setValue(necLong);
    }
    ...
    public Integer getSwcLat() {
        final Number value = getFieldToNumber(Fields.SWC_LAT);
    ...
    public void setSwcLat(final Integer swcLat) {
        final Field<?> f = getOrAddField(Fields.SWC_LAT);
        f.setValue(swcLat);
    }
    ...
    public Integer getSwcLong() {
        final Number value = getFieldToNumber(Fields.SWC_LONG);
    ...
    public void setSwcLong(final Integer swcLong) {
        final Field<?> f = getOrAddField(Fields.SWC_LONG);
        f.setValue(swcLong);
    }
    ...
    public Integer getTrainingStressScore() {
        final Number value = getFieldToNumber(Fields.TRAINING_STRESS_SCORE);
    ...
    public void setTrainingStressScore(final Integer trainingStressScore) {
        final Field<?> f = getOrAddField(Fields.TRAINING_STRESS_SCORE);
        f.setValue(trainingStressScore);
    }
    ...
    public Integer getIntensityFactor() {
        final Number value = getFieldToNumber(Fields.INTENSITY_FACTOR);
    ...
    public void setIntensityFactor(final Integer intensityFactor) {
        final Field<?> f = getOrAddField(Fields.INTENSITY_FACTOR);
        f.setValue(intensityFactor);
    }
    ...
    public Long getAvgStrokeCount() {
        final Number value = getFieldToNumber(Fields.AVG_STROKE_COUNT);
    ...
    public void setAvgStrokeCount(final Long avgStrokeCount) {
        final Field<?> f = getOrAddField(Fields.AVG_STROKE_COUNT);
        f.setValue(avgStrokeCount);
    }
    ...
    public Integer getPoolLength() {
        final Number value = getFieldToNumber(Fields.POOL_LENGTH);
    ...
    public void setPoolLength(final Integer poolLength) {
        final Field<?> f = getOrAddField(Fields.POOL_LENGTH);
        f.setValue(poolLength);
    }
    ...
    public Integer getThresholdPower() {
        final Number value = getFieldToNumber(Fields.THRESHOLD_POWER);
    ...
    public void setThresholdPower(final Integer thresholdPower) {
        final Field<?> f = getOrAddField(Fields.THRESHOLD_POWER);
        f.setValue(thresholdPower);
    }
    ...
    public Integer getPoolLengthUnit() {
        final Number value = getFieldToNumber(Fields.POOL_LENGTH_UNIT);
    ...
    public void setPoolLengthUnit(final Integer poolLengthUnit) {
        final Field<?> f = getOrAddField(Fields.POOL_LENGTH_UNIT);
        f.setValue(poolLengthUnit);
    }
    ...
    public Long getAvgLapTime() {
        final Number value = getFieldToNumber(Fields.AVG_LAP_TIME);
    ...
    public void setAvgLapTime(final Long avgLapTime) {
        final Field<?> f = getOrAddField(Fields.AVG_LAP_TIME);
        f.setValue(avgLapTime);
    }
    ...
    public Integer getBestLapIndex() {
        final Number value = getFieldToNumber(Fields.BEST_LAP_INDEX);
    ...
    public void setBestLapIndex(final Integer bestLapIndex) {
        final Field<?> f = getOrAddField(Fields.BEST_LAP_INDEX);
        f.setValue(bestLapIndex);
    }
    ...
    public String getOpponentName() {
        return getFieldToString(Fields.OPPONENT_NAME);
    }
    ...
    public void setOpponentName(final String opponentName) {
        final Field<?> f = getOrAddField(Fields.OPPONENT_NAME);
        f.setValue(opponentName);
    }
    ...
    public Integer getMaxBallSpeed() {
        final Number value = getFieldToNumber(Fields.MAX_BALL_SPEED);
    ...
    public void setMaxBallSpeed(final Integer maxBallSpeed) {
        final Field<?> f = getOrAddField(Fields.MAX_BALL_SPEED);
        f.setValue(maxBallSpeed);
    }
    ...
    public Integer getAvgBallSpeed() {
        final Number value = getFieldToNumber(Fields.AVG_BALL_SPEED);
    ...
    public void setAvgBallSpeed(final Integer avgBallSpeed) {
        final Field<?> f = getOrAddField(Fields.AVG_BALL_SPEED);
        f.setValue(avgBallSpeed);
    }
    ...
    public Integer getSportIndex() {
        final Number value = getFieldToNumber(Fields.SPORT_INDEX);
    ...
    public void setSportIndex(final Integer sportIndex) {
        final Field<?> f = getOrAddField(Fields.SPORT_INDEX);
        f.setValue(sportIndex);
    }
