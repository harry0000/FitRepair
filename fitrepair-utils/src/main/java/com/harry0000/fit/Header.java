...
public class Header {
    ...
    private static final int HEADER_WITH_CRC_SIZE = 14;
    private final byte[] header = new byte[HEADER_WITH_CRC_SIZE];
    ...
    public void updateCRC() {
        ...
        header[Format.CRC.getOffset()]     = (byte) (crc.getValue()        & 0xFF);
        header[Format.CRC.getOffset() + 1] = (byte) ((crc.getValue() >> 8) & 0xFF);
    }
